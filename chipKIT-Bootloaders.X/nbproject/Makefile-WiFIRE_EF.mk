...
ifeq "$(wildcard nbproject/Makefile-local-WiFIRE_EF.mk)" "nbproject/Makefile-local-WiFIRE_EF.mk"
include nbproject/Makefile-local-WiFIRE_EF.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-WiFIRE_EF.mk dist/${CND_CONF}/${IMAGE_TYPE}/chipKIT-Bootloaders.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
	@echo "User defined post-build step: [copy /Y /B dist\${ConfName}\production\chipKIT-Bootloaders.X.production.hex ..\..\BootloadersCurrent-hex\chipKIT-WiFire-EF.hex]"
	@copy /Y /B dist\${ConfName}\production\chipKIT-Bootloaders.X.production.hex ..\..\BootloadersCurrent-hex\chipKIT-WiFire-EF.hex
	@echo "--------------------------------------"
...
${OBJECTDIR}/_ext/1472/crt0MZ.o: ../crt0MZ.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/crt0MZ.o 
	@${RM} ${OBJECTDIR}/_ext/1472/crt0MZ.o.ok ${OBJECTDIR}/_ext/1472/crt0MZ.o.err 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/crt0MZ.o.d" "${OBJECTDIR}/_ext/1472/crt0MZ.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION) -I".." -MMD -MF "${OBJECTDIR}/_ext/1472/crt0MZ.o.d"  -o ${OBJECTDIR}/_ext/1472/crt0MZ.o ../crt0MZ.S  -DXPRJ_WiFIRE_EF=$(CND_CONF)  -no-legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/_ext/1472/crt0MZ.o.asm.d",--gdwarf-2,-I".." -DPIC32MZ -DINIT_MMU_MZ_FIXED -DINIT_SSX -DINIT_L1_CACHE -DINIT_DSPR2 -DPIC32_SRS_SET_COUNT=8 
...
${OBJECTDIR}/_ext/1472/pic32_init_cache.o: ../pic32_init_cache.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/pic32_init_cache.o 
	@${RM} ${OBJECTDIR}/_ext/1472/pic32_init_cache.o.ok ${OBJECTDIR}/_ext/1472/pic32_init_cache.o.err 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/pic32_init_cache.o.d" "${OBJECTDIR}/_ext/1472/pic32_init_cache.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION) -I".." -MMD -MF "${OBJECTDIR}/_ext/1472/pic32_init_cache.o.d"  -o ${OBJECTDIR}/_ext/1472/pic32_init_cache.o ../pic32_init_cache.S  -DXPRJ_WiFIRE_EF=$(CND_CONF)  -no-legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/_ext/1472/pic32_init_cache.o.asm.d",--gdwarf-2,-I".." -DPIC32MZ -DINIT_MMU_MZ_FIXED -DINIT_SSX -DINIT_L1_CACHE -DINIT_DSPR2 -DPIC32_SRS_SET_COUNT=8 
...
${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o: ../pic32_init_tlb_ebi_sqi.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o 
	@${RM} ${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o.ok ${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o.err 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o.d" "${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION) -I".." -MMD -MF "${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o.d"  -o ${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o ../pic32_init_tlb_ebi_sqi.S  -DXPRJ_WiFIRE_EF=$(CND_CONF)  -no-legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/_ext/1472/pic32_init_tlb_ebi_sqi.o.asm.d",--gdwarf-2,-I".." -DPIC32MZ -DINIT_MMU_MZ_FIXED -DINIT_SSX -DINIT_L1_CACHE -DINIT_DSPR2 -DPIC32_SRS_SET_COUNT=8 
...
${OBJECTDIR}/_ext/1472/main.o: ../main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/main.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/main.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -mno-float -O2 -D_BOARD_CHIPKIT_WIFIRE_EF -I".." -MMD -MF "${OBJECTDIR}/_ext/1472/main.o.d" -o ${OBJECTDIR}/_ext/1472/main.o ../main.c    -DXPRJ_WiFIRE_EF=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/chipKIT-Bootloaders.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../MZ-boot-linkerscript.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION) -nostdlib -nostartfiles -mno-float -o dist/${CND_CONF}/${IMAGE_TYPE}/chipKIT-Bootloaders.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_WiFIRE_EF=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-L"../../../../../../../../Program Files (x86)/Microchip/MPLAB C32 Suite/lib",-L"../../../../../../../../Program Files (x86)/Microchip/MPLAB C32 Suite/pic32mx/lib",-Map="${DISTDIR}/MX7cK.X.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml,-Os,
